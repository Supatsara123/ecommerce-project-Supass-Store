                ...
                <form method="POST" action="{{ route('product.insert') }}" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 mb-3">
                            ...
                            <input type="text" id="slug" name="slug" value="{{ old('slug') }}" class="form-control @error('slug') is-invalid @enderror" oninput="this.value = this.value.toLowerCase()">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                            ...
                            <div class="input-group has-validation">
                                <input type="number" min="1" name="original_price" value="{{ old('original_price') }}" class="form-control @error('original_price') is-invalid @enderror">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                            ...
                            <div class="input-group has-validation">
                                <input type="number" min="0" name="selling_price" value="{{ old('selling_price') }}" class="form-control @error('selling_price') is-invalid @enderror">
                                <span class="input-group-text">฿</span>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                            ...
                            <div class="input-group has-validation">
                                <input type="number" min="1" name="quantity" value="{{ old('quantity') }}" class="form-control @error('quantity') is-invalid @enderror">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                            ...
                            <div class="input-group has-validation">
                                <input type="number" step="0.01" min="0.01" name="weight" value="{{ old('weight') }}" class="form-control @error('weight') is-invalid @enderror">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                            ...
                            <div class="input-group has-validation">
                                <input type="number" step="0.1" min="0" name="tax" value="{{ old('tax') }}" class="form-control @error('tax') is-invalid @enderror">
                                <span class="input-group-text">%</span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="file" accept=".jpg,.gif,.png" id="image" name="image" class="form-control @error('image') is-invalid @enderror">
                            @error('image')
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                            ...
                            <div class="col">
                                ...
                                <input type="checkbox" name="trending" class="@error('trending') is-invalid @enderror" {{ old('trending') ? 'checked' : '' }}>
